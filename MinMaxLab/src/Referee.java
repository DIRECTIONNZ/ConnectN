...
public class Referee
{
	...
	static Player player1 = new SimplePlayer("Jacob3", 1, timeLimit); // you should create your own player class and use it here
	static Player player2 = new SimplePlayer("Nan2", 2, timeLimit);
