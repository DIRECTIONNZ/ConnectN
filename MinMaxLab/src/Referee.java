...
public class Referee
{
	...
	static int timeLimit = 1; // the time, in seconds, allowed for each player to provide a move
	static Player player1 = new AIPlayer("Jacob", 1, timeLimit); // you should create your own player class and use it here
	static Player player2 = new SimplePlayer("Nan", 2, timeLimit);
